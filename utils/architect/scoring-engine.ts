...
export const DEF_MATRIX = [
  ...
  /* 11 Dutch-Award     */ [[-999, 5, 10],    [-15, 5, 10],     [10, -999, -999],  [8, 0, -999],       [0, 15, 5],          [0, 0, 10]],
  ...
  /* 15 Jap-Award       */ [[-999, 0, 5],     [-15, 5, 5],      [0, -999, -999],   [5, 0, -999],       [25, 5, 0],          [0, 0, 15]],
  /* 16 Jap-Rank        */ [[-999, 0, 5],     [-15, 5, 5],      [-999, 10, -999],  [5, 0, -999],       [25, 5, 0],          [0, 0, 15]],
  /* 17 Jap-NoRank      */ [[-999, 0, 5],     [-15, 5, 5],      [-999, -999, 10],  [5, 0, -999],       [25, 5, 0],          [0, 0, 15]],
  /* 18 Jap-Ceil-Aw     */ [[-999, 0, 5],     [-15, 5, 5],      [0, -999, -999],   [-999, -999, 5],    [25, 5, 0],          [0, 0, 15]],
