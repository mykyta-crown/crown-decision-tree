...
export const DEF_MATRIX = [
  ...
  /* 15 Jap-Award       */ [[-999, 0, 5],     [-15, 5, 5],      [0, -999, -999],   [5, -999, -999],    [5, 10, 5],          [0, 0, 15]],
  /* 16 Jap-Rank        */ [[-999, 0, 5],     [-15, 5, 5],      [-999, 10, -999],  [5, -999, -999],    [5, 10, 5],          [0, 0, 15]],
  /* 17 Jap-NoRank      */ [[-999, 0, 5],     [-15, 5, 5],      [-999, -999, 10],  [5, -999, -999],    [5, 10, 5],          [0, 0, 15]],
  /* 18 Jap-Ceil-Aw     */ [[-999, 0, 5],     [-15, 5, 5],      [0, -999, -999],   [-999, -999, 5],    [5, 10, 5],          [0, 0, 15]],
  /* 19 Jap-Ceil-Rk     */ [[-999, 0, 5],     [-15, 5, 5],      [-999, 10, -999],  [-999, -999, 5],    [5, 10, 5],          [0, 0, 15]],
  /* 20 Jap-Ceil-NR     */ [[-999, 0, 5],     [-15, 5, 5],      [-999, -999, 10],  [-999, -999, 5],    [5, 10, 5],          [0, 0, 15]],
