<template>
  <v-row>
    <v-col cols="12" md="3" class="d-flex align-stretch">
      <ProgressCircularTimer id="progress-circular-timer" />
    </v-col>
    <v-col md="3" class="d-flex align-stretch flex-column justify-space-between">
      <AuctionsDutchCurrentStateCard
        id="auctions-dutch-current-state-card"
  ...
  <v-row>
    <v-col cols="6">
      <AuctionsDutchSupplyBidCard
        id="auctions-dutch-supply-bid-card"
      ...
      <AuctionsDutchBidButton
        ...
        id="auctions-dutch-bid-button"
      />
    </v-col>
    <v-col cols="6">
      <v-tabs-window v-model="roundDisplay">
        <v-tabs-window-item value="#blocks">
          <AuctionsDutchRoundsCard
            id="auctions-dutch-rounds-card"
